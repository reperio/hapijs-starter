...
class Server {
    ...
    async startServer() {
        ...
        if (this.config.logDefaultFileTransport) {
            logTransports.push(new (require('winston-daily-rotate-file'))({
        ...
        if (this.config.logDefaultTraceTransport) {
            traceTransports.push(new (require('winston-daily-rotate-file'))({
        ...
        if (this.config.logDefaultActivityTransport) {
            activityTransports.push(new (require('winston-daily-rotate-file'))({
