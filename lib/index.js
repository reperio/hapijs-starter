...
class Server {
    constructor(options) {
        ...
        const {routes: additionalRouteOptions, ...additionalOptionsWithoutRouteOptions} = this.config.additionalOptions || {};
        ...
        const hapiConfig = Object.assign({}, { 
            ...
            }, additionalRouteOptions != null ? additionalRouteOptions : null), 
            cache: { 
